...
function loadPlayersPage() {
	for (var i = 0; i < players.length; i++){
		document.getElementById('player_selector').innerHTML += '<a href ="#" onclick=switchPlayers('+i+')>'+players[i].name+'</a> <br/>'
	}
